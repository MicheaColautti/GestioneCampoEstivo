          ...
          <div class="u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
              <p class="u-align-center u-custom-item u-text u-text-default u-text-2">
                <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" href="Admin/Disponibilità.html"><span class="u-file-icon u-icon u-icon-2"><img style="width:37px; height:37px;" src="{{URL::asset('storage/images/2886665.png')}}" alt=""></span>&nbsp; <br>Visualizza disponibilità<br>
                </a>
              </p>
            </div>
          </div>
      ...
      <div class="u-form u-form-1">
        <form action="#"  source="email" name="form" style="padding: 10px;">
          <div class="u-form-group u-form-name u-label-top">
            ...
            <input type="text" placeholder="Cerca" id="name-1e43" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-radius-50 u-white" required="">
          </div>
          <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-2">
            ...
            <div class="u-form-select-wrapper">
              <select id="select-05ce" name="type[]" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" size="5" multiple="multiple">
          ...
          <div class="u-form-group u-form-partition-factor-2 u-form-select u-label-top u-form-group-3">
            ...
            <div class="u-form-select-wrapper">
              <select id="select-37fe" name="stato[]" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" size="5" multiple="multiple">
          ...
          <div class="u-form-group u-form-select u-label-top u-form-group-4">
            ...
            <div class="u-form-select-wrapper">
              <select id="select-0fed" name="mansione[]" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" size="5" multiple="multiple">
                <option value="Cucina">Cucina</option>
                <option value="Accoglienza">Accoglienza</option>
                <option value="Lavanderia">Lavanderia</option>
                <option value="Refettorio">Refettorio</option>
                <option value="Infermieria">Infermieria</option>
              </select>
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12" version="1" class="u-caret"><path fill="currentColor" d="M4 8L0 4h8z"></path></svg>
            </div>
          </div>
          <div class="u-align-left u-form-group u-form-submit u-label-top">
            <a href="#" class="u-border-2 u-border-grey-75 u-btn u-btn-round u-btn-submit u-button-style u-none u-radius-50 u-btn-8">Cerca</a>
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-table-header u-table-header-1">
              <tr style="height: 45px;">
                ...
                <th class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-table-cell">Nazione </th>
                <th class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-table-cell">Ruolo</th>
              </tr>
            </thead>
            <tbody class="u-table-alt-palette-1-light-3 u-table-body">
            <?php
            $user=Auth::user()->name;  
            $results = DB::select("select name, lastname, country, type from person");
           
            $data = array("Id", "Nome", "Cognome","Numero di telefono", "Via","CAP","Nazione","Ruolo","Data di nascita","");
            ...
            foreach ($results as $el){
              ...
              for ($i=0;$i<count($realArray);$i++){
                print('<td class="u-table-cell">'.$realArray[$i]."</td>");
              }
              print('</tr>');
            }
          ?>

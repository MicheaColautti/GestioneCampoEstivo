      ...
      <div class="u-align-left u-form u-form-1">
        <form action="{{route('QueryAllData')}}" method="POST" class="" style="padding: 15px;" source="email" name="form"> @csrf <div class="u-form-group u-form-name u-label-top">
          ...
          <div class="u-form-group u-form-phone u-label-top">
            ...
            <input type="tel" id="text-3fc9" name="phoneNumber" pattern="[0-9]{4}-[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2}" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required" placeholder="0041-123-456-78-90">
          </div>
      ...
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-left u-form u-form-1">
          <div class="u-form-group u-form-select u-form-group-1">
            ...
            <div class="u-form-select-wrapper">
              <select id="select-c075" name="viveDropD" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
                ...
                <option value="Con il/la coniuge">Con il/la coniuge</option>
          ...
          <div class="u-form-group u-form-phone u-form-group-2">
            ...
            <input type="tel" placeholder="0041-123-456-78-90" id="phone-cb3f" name="institutePhone" pattern="[0-9]{4}-[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2}" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white">
          </div>
          <div class="u-align-left u-form-group u-form-submit u-label-top">
    ...
    <section class="u-align-center u-clearfix u-section-3" id="sec-third">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-align-left u-form u-form-1">
          ...
          <div class="u-form-group u-form-phone u-label-top">
            <label for="text-3fc9" class="u-label">Numero telefono</label>
            <input type="tel" id="text-3fc9" name="telefonoRef" pattern="[0-9]{4}-[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2}" class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="required" placeholder="0041-123-456-78-90">
          </div>
          <div class="u-align-left u-form-group u-form-submit u-label-top">

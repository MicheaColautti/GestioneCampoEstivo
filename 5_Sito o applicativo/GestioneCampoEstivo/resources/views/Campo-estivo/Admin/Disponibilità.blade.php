...
<html style="font-size: 16px;" lang="it"><head>
  ...
  <body class="u-body u-xl-mode" data-lang="it">
    <section class="u-clearfix u-valign-middle u-section-1" id="sec-456f">
          ...
          <div class="u-container-style u-list-item u-repeater-item">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
              <p class="u-align-center u-custom-item u-text u-text-default u-text-3">
                <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-3" href="../Sign-in.html"><span class="u-file-icon u-icon u-icon-3"><img style="width:37px; height:37px;" src="{{URL::asset('storage/images/992680.png')}}" alt=""></span>&nbsp; <br>Sign Out
                </a>
              </p>
            </div>
          </div>
      ...
      <h1 class="u-align-center u-text u-text-default u-text-palette-2-base u-text-4">C<span style="font-weight: 700;"></span>ampo estivo di Olivone
      </h1>
    ...
    <section class="u-clearfix u-section-2" id="sec-3a61">
      <div class="u-clearfix u-sheet u-sheet-1">
          ...
          <table class="u-table-entity">
            ...
            <thead class="u-palette-1-base u-table-header u-table-header-1">
              <tr style="height: 55px;">
                <th class="u-align-left u-border-1 u-border-black u-table-cell u-table-cell-1"><span class="u-file-icon u-icon u-text-white u-icon-1"><img style="width:37px; height:37px;" src="{{URL::asset('storage/images/507257-025d2c9e.png')}}" alt=""></span>
                </th>
                <th class="u-border-1 u-border-black u-table-cell"></th>
                <th class="u-border-1 u-border-black u-table-cell u-table-cell-3"></th>
                <th class="u-align-center u-border-1 u-border-black u-table-cell u-table-cell-4">MONTH</th>
                <th class="u-border-1 u-border-black u-table-cell"></th>
                <th class="u-border-1 u-border-black u-table-cell"></th>
                <th class="u-align-right u-border-1 u-border-black u-table-cell u-table-cell-7"><span class="u-file-icon u-icon u-text-white u-icon-2"><img style="width:37px; height:37px;" src="{{URL::asset('storage/images/271226-a90f2e2e.png')}}" alt=""></span>&nbsp; 
                </th>
              </tr>
            </thead>
        ...
        <div class="u-align-left u-form u-form-1">
          <form action="#"  source="email" name="form" style="padding: 10px;">
            <div class="u-form-checkbox u-form-group u-form-group-1">
              <input type="checkbox" id="checkbox-371c" name="checkbox" value="cucina">
              <label for="checkbox-371c" class="u-label">Cucina</label>
            </div>
            <div class="u-form-checkbox u-form-group u-form-group-2">
              <input type="checkbox" id="checkbox-70c8" name="checkbox-1" value="accoglienza">
              <label for="checkbox-70c8" class="u-label">Accoglienza</label>
            </div>
            <div class="u-form-checkbox u-form-group u-form-group-3">
              <input type="checkbox" id="checkbox-f15f" name="checkbox-2" value="lavanderia">
              <label for="checkbox-f15f" class="u-label">Lavanderia</label>
            </div>
            <div class="u-form-checkbox u-form-group u-form-group-4">
              <input type="checkbox" id="checkbox-4f0d" name="checkbox-3" value="refettorio">
              <label for="checkbox-4f0d" class="u-label">Refettorio<br>
              </label>
            </div>
            <div class="u-form-checkbox u-form-group u-form-group-5">
              <input type="checkbox" id="checkbox-fc93" name="checkbox-4" value="Infermieri">
        ...
        <div class="u-hidden-block u-repeater u-repeater-2"></div>
        <div class="u-container-style u-hidden-block u-list-item u-repeater-item u-list-item-1">
          <div class="u-container-layout u-similar-container u-container-layout-1"></div>
        </div>
        <div class="u-form u-form-2">
          <form action="#" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="email" name="form-1" style="padding: 10px;">
            <div class="u-form-group u-form-name u-label-none">
              <label for="name-1bfb" class="u-label">Nome</label>
              <input type="text" placeholder="Cerca" id="name-1bfb" name="cerca" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-align-right u-form-group u-form-submit u-label-none">
              <a href="#" class="u-btn u-btn-round u-btn-submit u-button-style u-radius-50">Invia</a>
              <input type="submit" value="submit" class="u-btn u-btn-submit u-button-style">
            </div>
            <div class="u-form-send-message u-form-send-success"> Grazie! Il tuo messaggio è stato inviato con successo! </div>
            <div class="u-form-send-error u-form-send-message"> Impossibile inviare il messaggio. Si prega di correggere gli errori e riprovare a inviare. </div>
